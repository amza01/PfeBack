...
const routes: Routes = [
    {
        path: '',
        redirectTo: '/auth/login', // Redirection vers la page de connexion par défaut
        pathMatch: 'full', // Assure que la redirection ne se produit que pour le chemin vide
    },
    {
        path: '',
...
@NgModule({
    ...
    providers: [AuthService], // Ajoute AuthService à la liste des fournisseurs
})
